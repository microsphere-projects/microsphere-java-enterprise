 ...
 */
package io.github.microsphere.enterprise.cache;

import io.github.microsphere.enterprise.cache.event.CacheEntryEventPublisher;
import io.github.microsphere.enterprise.cache.integration.CompositeFallbackStorage;
import io.github.microsphere.enterprise.cache.integration.FallbackStorage;
import io.github.microsphere.enterprise.cache.management.CacheStatistics;
import io.github.microsphere.enterprise.cache.management.DummyCacheStatistics;
import io.github.microsphere.enterprise.cache.management.SimpleCacheStatistics;
import io.github.microsphere.enterprise.cache.processor.MutableEntryAdapter;
...
import static io.github.microsphere.enterprise.cache.ExpirableEntry.requireKeyNotNull;
import static io.github.microsphere.enterprise.cache.ExpirableEntry.requireValueNotNull;
import static io.github.microsphere.enterprise.cache.configuration.ConfigurationUtils.immutableConfiguration;
import static io.github.microsphere.enterprise.cache.configuration.ConfigurationUtils.mutableConfiguration;
import static io.github.microsphere.enterprise.cache.event.GenericCacheEntryEvent.createdEvent;
import static io.github.microsphere.enterprise.cache.event.GenericCacheEntryEvent.expiredEvent;
import static io.github.microsphere.enterprise.cache.event.GenericCacheEntryEvent.removedEvent;
import static io.github.microsphere.enterprise.cache.event.GenericCacheEntryEvent.updatedEvent;
import static io.github.microsphere.enterprise.cache.management.ManagementUtils.registerMBeansIfRequired;
...
public abstract class AbstractCache<K, V> implements Cache<K, V> {
    ...
    private CacheStatistics resolveCacheStatistic() {
        // TODO Add Distributed CacheStatistics
