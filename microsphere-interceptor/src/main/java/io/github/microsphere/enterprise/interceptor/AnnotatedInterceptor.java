...
import static io.github.microsphere.enterprise.interceptor.util.InterceptorUtils.resolveInterceptorBinding;
...
public abstract class AnnotatedInterceptor<A extends Annotation> implements Interceptor, Prioritized {
    ...
    protected A findInterceptorBinding(Method method) {
        return resolveInterceptorBinding(method, interceptorBindingType);
    }

    protected A findInterceptorBinding(Constructor<?> constructor) {
        return resolveInterceptorBinding(constructor, interceptorBindingType);
    }
